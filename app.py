...
app.register_blueprint(auth_bp) # Login y registro en la raíz
app.register_blueprint(main_bp) # Cotizador en la raíz

# --- AQUÍ ESTABA EL ERROR: AGREGAMOS LOS PREFIJOS ---
